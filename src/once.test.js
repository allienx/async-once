...
describe('once', () => {
  ...
  describe('when the wrapped asyncFn is called multiple times and resolves', () => {
    const asyncData = [{ test: true }]
  ...
  describe('when the wrapped asyncFn is called multiple times and rejects', () => {
